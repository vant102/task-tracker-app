  ...
  return (
    <div className="rbc-toolbar custom-toolbar" style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.25rem', gap: '0.5rem', position: 'relative', zIndex: 100 }}>
      <div style={{ display: 'flex', gap: '0.5rem' }}>
        <button onClick={goToBack} title="Trước" style={{ padding: 0, borderRadius: '50%', width: '42px', height: '42px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, cursor: 'pointer' }}>
          <img src="/icons/Trước.png" alt="Prev" style={{ width: '22px', height: '22px', objectFit: 'contain' }} />
        </button>
        <button onClick={goToCurrent} title="Hôm nay" style={{ padding: 0, borderRadius: '50%', width: '42px', height: '42px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, cursor: 'pointer' }}>
          <img src="/icons/Hôm nay.png" alt="Today" style={{ width: '22px', height: '22px', objectFit: 'contain' }} />
        </button>
        <button onClick={goToNext} title="Sau" style={{ padding: 0, borderRadius: '50%', width: '42px', height: '42px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, cursor: 'pointer' }}>
          <img src="/icons/Tiếp.png" alt="Next" style={{ width: '22px', height: '22px', objectFit: 'contain' }} />
        </button>
      </div>
      
      <div className="rbc-toolbar-label" style={{ fontWeight: 'bold', fontSize: '1.1rem', color: 'var(--color-primary)', textAlign: 'center', flex: 1, minWidth: '120px' }}>
        {label()}
      </div>

      <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap', justifyContent: 'flex-end' }}>
        <button onClick={() => toolbar.onView('month')} className={toolbar.view === 'month' ? 'rbc-active' : ''} title="Tháng" style={{ padding: 0, borderRadius: '50%', width: '42px', height: '42px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, cursor: 'pointer' }}>
          <img src="/icons/Tháng.png" alt="Month" style={{ width: '22px', height: '22px', objectFit: 'contain' }} />
        </button>
        <button onClick={() => toolbar.onView('agenda')} className={toolbar.view === 'agenda' ? 'rbc-active' : ''} title="Lịch trình" style={{ padding: 0, borderRadius: '50%', width: '42px', height: '42px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, cursor: 'pointer' }}>
          <img src="/icons/Lịch trình.png" alt="Agenda" style={{ width: '22px', height: '22px', objectFit: 'contain' }} />
        </button>
      </div>
    </div>
  );
